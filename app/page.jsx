    ...
    return (
        <div className="container mx-auto px-4 py-8 max-w-[1600px]">
            ...
            <div className="mb-8 flex items-center justify-between flex-wrap gap-4">
                <div>
                    <h1 className="text-3xl md:text-4xl font-heading font-bold neon-text mb-2 text-light-text dark:text-cyber-text">
                        Your Task Boards
                    </h1>
                    <p className="text-light-textMuted dark:text-cyber-textMuted text-sm md:text-base">
                ...
                >
                    ...
                    <kbd className="hidden md:inline ml-2 px-2 py-0.5 text-xs bg-light-surface dark:bg-cyber-surface rounded border border-light-border dark:border-cyber-borderSubtle">C</kbd>
                </button>
            ...
            {loading ? (
                <div className="flex items-center justify-center min-h-[400px]">
                    <div className="flex flex-col items-center gap-4">
                        <div className="w-16 h-16 border-4 border-light-categoryHeading dark:border-cyber-primary border-t-transparent rounded-full animate-spin"></div>
                        <p className="text-light-textMuted dark:text-cyber-textMuted animate-pulse">Loading your boards...</p>
                    </div>
                </div>
            ) : categories.length === 0 ? (
                <div className="flex flex-col items-center justify-center min-h-[400px] text-center py-20">
                    <div className="w-24 h-24 mb-6 rounded-full bg-gradient-to-br from-cyber-primary to-cyber-secondary opacity-20 flex items-center justify-center animate-pulse">
                        <svg className="w-12 h-12 text-light-text dark:text-cyber-text" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2" />
                        </svg>
                    </div>
                    <h2 className="text-2xl font-heading font-bold mb-2 text-light-text dark:text-cyber-text">No categories yet</h2>
                    <p className="text-light-textMuted dark:text-cyber-textMuted mb-8 max-w-md">
            ...
            {hiddenCategories.length > 0 && (
                <div className="mt-8 p-4 glass-panel rounded-lg border-light-warning/30 dark:border-cyber-warning/30">
                    <div className="flex items-center gap-2 text-light-warning dark:text-cyber-warning">
                        <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            >
                <form onSubmit={handleAddCategory} className="space-y-6">
                    <div>
                        <label htmlFor="category-name" className="block text-sm font-semibold mb-2 text-light-text dark:text-cyber-text">
                            Category Name
                        </label>
                        <input
                            id="category-name"
                    ...
                    <div>
                        ...
                        />
                        <p className="mt-2 text-xs text-light-textMuted dark:text-cyber-textMuted">Highlights the category header.</p>
                    </div>
