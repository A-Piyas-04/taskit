...
export default function CategoryColumn({ category, index }) {
    ...
    const colorSchemes = [
        { border: 'border-cyber-primary', text: 'text-cyber-primary', bg: 'bg-cyber-primary' },
        { border: 'border-cyber-secondary', text: 'text-cyber-secondary', bg: 'bg-cyber-secondary' },
        { border: 'border-cyber-accent', text: 'text-cyber-accent', bg: 'bg-cyber-accent' },
        { border: 'border-cyber-success', text: 'text-cyber-success', bg: 'bg-cyber-success' },
    ];
                ...
                <div className="p-5 border-b border-cyber-borderSubtle">
                    <div className="flex items-start justify-between mb-3">
                        ...
                        >
                            ...
                            <h3 className={`text-lg font-heading font-bold tracking-wide ${colorScheme.text} group-hover:text-glow`}>
                                {category.name}
                            </h3>
                        </button>
                        <div className="flex items-center gap-2">
                            <Tooltip content="Toggle visibility">
                                <button
                                    ...
                                    className="p-1.5 hover:bg-cyber-surfaceLight rounded transition-colors"
